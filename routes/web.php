...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::resource('parent', 'PositionController');
    Route::get('parent_list', 'PositionController@list')->name('parent.list');
    ...
    Route::get('report_cumm' , 'ReportController@cumm')->name('report.cumm');
    ...
    //Route::get('exam_compilation', 'ExamController@examc')->name('exam.compilation');
    Route::post('print_4exam', 'ExamController@print4exam')->name('exam.4print');
    Route::post('print_4cumm', 'ExamController@print4cumm')->name('exam.4cumm');
