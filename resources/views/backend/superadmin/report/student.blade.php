        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <span class="text-primary font-weight-bold"><small>Please generate result first or ask principal to generate result</small></span>
                </div>
                    <div class="row justify-content-md-center d-print-none" style="margin-bottom: 10px;">
                        <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-3 mb-lg-0">
                            <select class="form-control" name="exam_id" id="exam_id">
                                <option value="all">{{ translate('select_a_semester') }}</option>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-3 mb-lg-0">
                            <select class="form-control" name="class_id" id="class_id" onchange="classWiseSection(this.value)">
                                <option value="all">{{ translate('select_a_programme') }}</option>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-3 mb-lg-0" id = "section_content">
                            <select class="form-control" name="section_id" id="section_id">
                                <option value="all">{{ translate('select_a_level') }}</option>
                            </select>
                        </div>
